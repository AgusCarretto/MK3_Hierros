...
| feat-005 | El sitio público (catálogo, detalle de trabajo, contacto) tiene un rediseño premium sobre Vite + Tailwind + Radix UI, con skeletons/toasts/empty-states y sin cambios de contrato de API | `cd mk3_hierros_front && npm run build` | active | exec-plan front-002 | Ver `docs/exec-plans/active/2026-08-17_front-002_frontend-redesign-v2.md` |
